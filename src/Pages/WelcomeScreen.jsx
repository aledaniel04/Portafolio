...
import { Code2, Github, BriefcaseBusiness , User } from 'lucide-react';
import AOS from 'aos';
              ...
              >
                ...
                >
                  ...
                  <div className="relative flex items-center gap-2 text-lg sm:text-xl md:text-2xl">
                    <BriefcaseBusiness className="w-4 h-4 sm:w-5 sm:h-5 text-indigo-600" />
                    <span className="bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
                      <TypewriterEffect text="By: Alessandro" />
                    </span>
                  </div>
                </div>
              </motion.div>
